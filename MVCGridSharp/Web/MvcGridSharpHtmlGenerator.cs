...
//Feature Requests
//Show/hide fields
public class MvcGridSharpHtmlGenerator
{
    ...
    public static string GenerateClientDataTransferHtml(GridContext gridContext)
    {
        ...
        sb.AppendFormat("<div id='MvcGridSharp_{0}_ContextJsonData' style='display: none;'>", gridContext.GridName);
    ...
    public static string GenerateBasePageHtml(string gridName, IMvcGridSharpDefinition def, object pageParameters, string applicationPath = "")
    {
        ...
        sbHtml.AppendFormat("<input type='hidden' name='MvcGridSharpName' value='{0}' />", gridName);
        sbHtml.AppendFormat("<div id='MvcGridSharp_{0}_JsonData' style='display: none'>{1}</div>", gridName, definitionJson);

        sbHtml.AppendFormat("<div id='MvcGridSharp_ErrorMessage_{0}' style='display: none;'>", gridName);
    ...
    private static string GenerateJsonPageParameters(object pageParameters)
    {
        ...
        Dictionary<string, string> pageParamsDict = [];
    ...
    private static string GenerateClientDefinitionJson(string gridName, IMvcGridSharpDefinition def, object pageParameters)
    {

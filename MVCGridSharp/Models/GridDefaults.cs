...
public class GridDefaults : IMvcGridSharpDefinition
{
    public GridDefaults()
    {
        PreloadData = true;
        ...
        Filtering = false;
        //RenderingEngine = typeof(MvcGridSharp.Rendering.BootstrapRenderingEngine);
        TemplatingEngine = typeof(MvcGridSharp.Templating.SimpleTemplatingEngine);
        AdditionalSettings = [];
        RenderingMode = Models.RenderingMode.RenderingEngine;
        ViewPath = "~/Views/MvcGridSharp/_Grid.cshtml";
        ...
        {
            MvcGridSharp.Models.RenderingEngine.BootstrapRenderingEngine,
            MvcGridSharp.Models.RenderingEngine.ExportDefault,
        };
    ...
    public IEnumerable<IMvcGridSharpColumn> GetColumns()
    {

...
public class GridDefinition<T1> : GridDefinitionBase, IMvcGridSharpDefinition
{
    ...
    {
        return Columns.Cast<IMvcGridSharpColumn>();
    }
    ...
    public override List<Row> GetData(GridContext context, out int? totalRecords)
    {
        ...
        IMvcGridSharpTemplatingEngine templatingEngine = (IMvcGridSharpTemplatingEngine)Activator.CreateInstance(context.GridDefinition.TemplatingEngine, true);
